...
fet_targets <- c('ELEV','TEMP','TEMP_MAX','TEMP_MIN','TEMPmax','TEMPmin','TEMPmax_MAX','TEMPmin_MIN','PREC','PREC_MIN','PREC_MAX','PRECsp_MIN','PRECsp_MAX','NPP','NPP_MIN','NDVI','NDVI_MIN','no_species_fact')
